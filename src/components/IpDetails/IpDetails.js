			...
			{props.ipDetails ? (
				<div className='ip-details-main-div'>
					...
					<div className='ip-details-div right-bar'>
						...
						<div className='rubik-700-drk-gray ip-details-value'>{`${props.ipDetails?.location?.city}, ${props.ipDetails?.location?.region}`}</div>
					</div>
					<div className='ip-details-div right-bar'>
						<p className='rubik-700-lgh-gray ip-details-title'>TIMEZONE</p>
						<div className='rubik-700-drk-gray ip-details-value'>{`UTC ${props.ipDetails?.location?.timezone}`}</div>
					</div>
